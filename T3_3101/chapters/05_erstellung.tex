...
%         \vspace*{-3cm}
%         \centering
%         \raisebox{1.5\height}{\includegraphics[width=0.28\textwidth]{res/pictures/res-block.pdf}}

%     } & \multicolumn{2}{|l|}{\parbox{0.7\textwidth}{ Anschließend werden die Daten durch einen Stapel an \enquote{Residual Block} Elementen geleitet. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Modi omnis quibusdam optio adipisci perspiciatis molestiae. Error consequatur assumenda facilis. Quaerat inventore quis reiciendis voluptatem possimus! Corporis sunt repudiandae provident soluta. }} \\ \hline
%     & \multirow{2}{0.35\textwidth}{ Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo voluptatum ex veritatis optio, ad architecto possimus repudiandae iste, necessitatibus deleniti consequatur aliquid consectetur non, autem hic accusamus neque iusto ipsa! } &  \multirow{3}{0.35\textwidth}{
%         \vspace*{-3cm}
%         \centering
%         \includegraphics[width=0.33\textwidth]{res/pictures/squeeze-and-excitation-block.pdf}
%         % \captionof{figure}[Squeeze \& Excitation Block]{\unskip}\label{fig:squeeze-and-excitation-block}
%         % Squeeze \& Excitation Block
%     } \\ \hline
%     \begin{tabular}[c]{@{}l@{}}
%         \captionof{figure}[Residual Block]{\unskip}\label{fig:resblock} \\
%         Residual Block
%     \end{tabular} & & \\
%     \multicolumn{2}{|l|}{\parbox{0.65\textwidth}{ Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quidem laboriosam voluptates ipsa pariatur minima, fugiat ratione debitis optio esse quibusdam veritatis tempore quod eius beatae ullam quaerat sed nam distinctio! }} &  \\
% \end{tabular}
...
Lorem ipsum dolor sit amet consectetur, adipisicing elit. Autem in qui quia pariatur libero omnis voluptas iusto sint quae vero sit nisi adipisci eius, doloremque, est ab sapiente porro? Veritatis. Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates quidem facere, libero corrupti incidunt numquam nostrum tenetur temporibus, inventore quibusdam magnam nihil corporis consequuntur eius recusandae repellendus soluta repellat ea! Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum maxime inventore commodi odio quia iure, doloribus dignissimos facilis deleniti quas ipsum nihil culpa voluptate. Sit quas nemo quis iusto reiciendis.
