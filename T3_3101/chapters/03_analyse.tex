...
\begin{figure}[!ht]
    ...
    \begin{adjustbox}{width=\textwidth,keepaspectratio}
        \begin{tikzpicture}[
            ...
            \node[draw, circle, inner sep=2pt, label=left:Start] (start) at (0,0) {};
            ...
            \node[draw, circle, inner sep=2pt, label=left:Ende] (end) at (start |- take16)  {};
...
\begin{figure}[!ht]
    \centering
    \begin{tikzpicture}
        \node [inner sep=0pt,outer sep=0pt,clip,rounded corners=0.15cm] (image) at (0,0) {\includegraphics[width=0.4\textwidth]{res/pictures/max-score-quilt-board.jpg}};
        \drawshadow{image}
    \end{tikzpicture}
    % \vspace*{-0.5cm}
