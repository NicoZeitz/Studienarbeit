...
\begin{table}[!ht]
    ...
    \begin{tabular}[t]{c|c}
        ...
        \hspace*{0.5cm} \adjustbox{valign=m}{\includegraphics[width=0.15\textwidth]{res/pictures/assets/00-front.png}} \hspace*{0.5cm} & \hspace*{0.5cm}
        $\left( 9 - 1 + 1 \right) \cdot \left( 9 - 2 + 1 \right) \cdot 2 = 144$ \hspace*{0.5cm}                                                                    \\ \hline
        \hspace*{0.5cm} \adjustbox{valign=m}{\includegraphics[width=0.15\textwidth]{res/pictures/assets/09-front.png}} \hspace*{0.5cm} & \hspace*{0.5cm}
        $\left( 9 - 2 + 1 \right) \cdot \left( 9 - 2 + 1 \right) \cdot 1 = 64$ \hspace*{0.5cm}                                                                     \\ \hline
        \hspace*{0.5cm} \adjustbox{valign=m}{\includegraphics[width=0.15\textwidth]{res/pictures/assets/21-front.png}} \hspace*{0.5cm} & \hspace*{0.5cm}
...
\begin{figure}[!ht]
    \centering
    % TODO:FABIAN: dieses Bild vielleicht mal in echt Aufnehmen?
    \begin{tikzpicture}
        \node [inner sep=0pt,,outer sep=0pt,clip,rounded corners=0.15cm] (image) at (0,0) {\includegraphics[width=0.45\textwidth]{res/pictures/max-button-income.png}};
        \drawshadow{image}
    \end{tikzpicture}
    % \vspace*{-0.5cm}
    \caption{Anordnung von Flicken mit einem Knopfeinkommen von 32}
    \label{fig:quilt-board-max-button-income}
\end{figure}

TODO: Time Cost is 66
...
% TODO: hyperreferencen für Komplexitätsparameter (e.g. Spielbaumkomplexität) einfügen
