...
{
    \setkeys{Gin}{draft=false}
    \include{chapters/04_modellierung}
}
\include{chapters/05_erstellung}
\include{chapters/06_umsetzung}
\include{chapters/07_evaluation}
\include{chapters/08_fazit}
...
\include{chapters/A_quellcode}
\include{chapters/B_bilder}
\include{chapters/C_patchwork}
