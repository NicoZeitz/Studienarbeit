...
impl Entry {
    ...
    /// * `usize` - The action id
    #[inline]
    pub(crate) fn get_action_id(data: u64) -> ActionId {
    ...
    #[inline]
    pub(crate) fn get_evaluation(data: u64) -> i32 {
    ...
    pub(crate) fn unpack_data(data: u64) -> (usize, i32, EvaluationType, ActionId) {
